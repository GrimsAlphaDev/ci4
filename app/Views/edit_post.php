...
<form action="/blog/update/<?= $post['post_id'] ?>" method="POST">
    ...
    <div class="relative z-0 w-full mb-5 group">
        ...
        value="<?= (old('title') != null) ? old('title') : $post['post_title'] ?>"  
        />
    ...
    <div class="relative z-0 w-full mb-5 group">
        ...
        <textarea name="post_content" id="floating_content" class="block py-2.5 px-0 w-full text-sm text-black bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required><?= (old('post_content') != null) ? old('post_content') : $post['post_description'] ?></textarea>
