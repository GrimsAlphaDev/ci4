...
<form action="<?= base_url('admin/blog/new') ?>" method="POST" enctype="multipart/form-data">
    ...
    <div class="relative z-0 w-full mb-5 group">
        <input type="file" name="image" id="floating_image" class="block py-2.5 px-0 w-full text-sm text-black bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required accept="image/*" />
        ...
        <img src="" alt="" class="hidden w-100" id="preview_image" />
    </div>
